...
//           bool              verify( const fc::sha256& digest, const signature& sig );
     ...
     range_proof_info range_get_info( const range_proof_type& proof );
       ...
       * YOSEMITE Shims
       */
      struct yosemite_public_key_shim : public crypto::shim<public_key_data> {
          using crypto::shim<public_key_data>::shim;
      ...
      struct yosemite_signature_shim : public crypto::shim<compact_signature> {
          using public_key_type = yosemite_public_key_shim;
          using crypto::shim<compact_signature>::shim;
      ...
      struct yosemite_private_key_shim : public crypto::shim<private_key_secret> {
          using crypto::shim<private_key_secret>::shim;
          using signature_type = yosemite_signature_shim;
          using public_key_type = yosemite_public_key_shim;
          ...
          static yosemite_private_key_shim generate()
          {
              return yosemite_private_key_shim(private_key::generate().get_secret());
          }
...
FC_REFLECT_DERIVED( fc::ecc::yosemite_public_key_shim, (fc::crypto::shim<fc::ecc::public_key_data>), BOOST_PP_SEQ_NIL )
FC_REFLECT_DERIVED( fc::ecc::yosemite_signature_shim, (fc::crypto::shim<fc::ecc::compact_signature>), BOOST_PP_SEQ_NIL )
FC_REFLECT_DERIVED( fc::ecc::yosemite_private_key_shim, (fc::crypto::shim<fc::ecc::private_key_secret>), BOOST_PP_SEQ_NIL )
